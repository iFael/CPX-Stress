...
- [x] **ANALYTICS-03**: Usuário pode visualizar uma tela de análise cross-test que compara a distribuição de erros entre múltiplos testes históricos, identificando se erros de uma operação específica pioram com o tempo ou com aumento de carga
